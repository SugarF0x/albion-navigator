...
@onready var image_inspector_1: ImageInspector = %ImageInspector1
@onready var image_inspector_2: ImageInspector = %ImageInspector2
@onready var controls_container: HBoxContainer = %ControlsContainer
@onready var captures_container: HBoxContainer = %CapturesContainer
...
func set_os_visibility() -> void:
	if OS.get_name() == "Windows": return
	controls_container.visible = false
	captures_container.visible = false
